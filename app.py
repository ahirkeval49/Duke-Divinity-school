...
st.sidebar.image("https://divinity.duke.edu/sites/divinity.duke.edu/files/styles/hero_full/public/2021-03/div_homepage.jpg", use_column_width=True)

# Home Page
if menu == "Home":
    st.title("Welcome to Duke Divinity School Insights 📘")
    st.image("https://divinity.duke.edu/sites/divinity.duke.edu/files/duke_divinity_logo.png", use_column_width=True)
    st.write(
        """
